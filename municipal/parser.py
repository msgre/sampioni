...
import sys
with open("/Users/msgre/Downloads/sampioni/20/txt/materialy_20_%02i.txt" % int(sys.argv[1])) as f:
    lines = [i.decode('utf-8').rstrip() for i in f.readlines()]
    text = convert_to_markdown(lines)
    print text
